...
console.log('🔌 Testing Node WebSocket subscription flow with correct node names...');
...
ws.on('open', () => {
	...
	setTimeout(() => {
		...
		console.log('📤 Sending corrected node subscription:', JSON.stringify(subscription, null, 2));
