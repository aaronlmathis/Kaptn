/**
 * Filter Bar Component for OpsView
 * 
 * Provides comprehensive filtering controls for operational metrics including
...
// Filter bar props
export interface OpsViewFilterBarProps {
...
// Scope options - focused on operations
const SCOPE_OPTIONS: Array<{ value: MetricScope; label: string; description: string }> = [
	{ value: 'cluster', label: 'Cluster', description: 'Cluster-wide operations overview' },
	{ value: 'node', label: 'Node', description: 'Node-level operational metrics' },
	{ value: 'namespace', label: 'Namespace', description: 'Namespace-scoped operations' },
	{ value: 'workload', label: 'Workload', description: 'Deployment, StatefulSet, DaemonSet' },
	{ value: 'pod', label: 'Pod', description: 'Pod-level operational metrics' },
];
...
/**
 * OpsView Filter Bar Component
 */
export function OpsViewFilterBar({
	filters,
	onFiltersChange,
	onExpandAll,
	onCollapseAll,
			...
			<div className="flex flex-wrap items-center gap-6 px-6 py-5">
				...
				<div className="flex items-center gap-3 flex-1 min-w-[280px] w-full sm:w-auto">
					...
					<div className="relative flex-1 max-w-[400px]">
						...
						<Input
							id="search-input"
							placeholder="Filter operations data and sections..."
							value={searchValue}
