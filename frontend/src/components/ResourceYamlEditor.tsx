	...
	return (
		<Dialog open={isOpen} onOpenChange={setIsOpen}>
			...
			<DialogContent className="max-w-6xl sm:max-w-6xl h-[80vh] flex flex-col">
				<DialogHeader>
					<DialogTitle>Edit {resourceKind} YAML</DialogTitle>
